...
class PDFExportAssetBulkProcessingAction extends AbstractAssetBulkProcessingAction
{
    /**
     * @inheritDoc
     */
...
//        $options->setDefaultFont(StyleHandler::getInstance()->getStyle()->getEmailFontFamily());
        ...
        $canvas->page_script(function ($pageNumber, $pageCount, $canvas, $fontMetrics) {
            $text = WCF::getLanguage()->getDynamicVariable('assets.acp.asset.bulkProcessing.pdfexport.footer', [
